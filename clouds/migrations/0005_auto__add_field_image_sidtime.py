...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.sidtime'
        db.add_column('clouds_image', 'sidtime',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clouds.SidTime'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.sidtime'
        db.delete_column('clouds_image', 'sidtime_id')
