...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RealPoint.generation'
        db.add_column('clouds_realpoint', 'generation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['clouds.RealPointGeneration']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RealPoint.generation'
        db.delete_column('clouds_realpoint', 'generation_id')
