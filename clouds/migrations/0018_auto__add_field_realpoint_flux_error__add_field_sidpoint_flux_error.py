...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RealPoint.flux_error'
        db.add_column('clouds_realpoint', 'flux_error',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'SidPoint.flux_error'
        db.add_column('clouds_sidpoint', 'flux_error',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RealPoint.flux_error'
        db.delete_column('clouds_realpoint', 'flux_error')

        # Deleting field 'SidPoint.flux_error'
        db.delete_column('clouds_sidpoint', 'flux_error')
