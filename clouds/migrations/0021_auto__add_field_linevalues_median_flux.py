...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LineValues.median_flux'
        db.add_column('clouds_linevalues', 'median_flux',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LineValues.median_flux'
        db.delete_column('clouds_linevalues', 'median_flux')
