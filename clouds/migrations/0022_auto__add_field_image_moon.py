...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.moon'
        db.add_column('clouds_image', 'moon',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.moon'
        db.delete_column('clouds_image', 'moon')
    ...
    models = {
        'clouds.image': {
            ...
            'moon': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'clouds.linevalues': {
            ...
            'median_flux': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
